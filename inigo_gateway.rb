...
class InigoGateway < Formula
  ...
  on_macos do
    url "https://github.com/inigolabs/artifacts/releases/download/v0.30.20/gateway_darwin_all.tar.gz"
  ...
  on_linux do
    if Hardware::CPU.arm? && Hardware::CPU.is_64_bit?
      url "https://github.com/inigolabs/artifacts/releases/download/v0.30.20/gateway_linux_arm64.tar.gz"
    ...
    if Hardware::CPU.intel?
      url "https://github.com/inigolabs/artifacts/releases/download/v0.30.20/gateway_linux_amd64.tar.gz"
